...
namespace Lesson_57_Library
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Question 155: Testing cannot PROVE code is correct, as it's possible to have missed an edge case. It can prove code is incorrect.
            // It can help you identify bugs but can't guarantee you'll find all bugs.



            Bag<string> bag1 = new Bag<string>();
            Console.WriteLine("bag1 contents: " + string.Join(",", bag1));
            ...
            Console.WriteLine("bag2 contents: " + string.Join(",", bag2));

            Bag<char> bag3 = new Bag<char>();
            ...
            Console.WriteLine("bag3 contents: " + string.Join(",", bag3));
